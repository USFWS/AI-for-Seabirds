...
class Slicer(object):
    ...
    def __init__(self):
        ...
        self.save_before_after_map = True
    ...
    def __slice_images(self, tile_size, tile_overlap, number_tiles):
        ...
        for file in image_files:
            ...
            for tile in tiles:
                ...
                print("tile id str: ", tile_id_str)
                tile_id_str = os.path.basename(tile_id_str)
                print("tile id str: ", tile_id_str)
            ...
            #for file in file_name:
             #   file =
                ...
                # Pillow: im1 = im.crop((left, top, right, bottom))
                if self._mapper:
                    print("self mapper!")
                    ...
                    if tile_id_str in self._mapper[file_name]:
                        print ("it's in there!")
                        new_im = im.crop(tile)
                        new_im.save('{}/{}.{}'.format(self.IMG_DST, tile_id_str, ".jpg"))
