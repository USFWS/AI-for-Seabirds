...
root_dir = "D:/seabird_winter/2025_winter_seabirds_121k_next/"

new_csv = "D:/seabird_winter/YOLOv11_winter_seabirds_121k_next.csv"
...
for root, dirs, files in os.walk(root_dir):
    for file in files:
        if file.endswith("jpg"):
            ...
            result.export_visuals(file_name=base, export_dir="D:/WHCR_2025/12_WHCR_detection/g_inference/4_new-tiles_viz/",
